...
<header class="edica-header">
    <div class="container">
        <nav class="navbar navbar-expand-lg navbar-light">
            <a class="navbar-brand" href="{{ route('main') }}"><img src="{{ asset("edica/assets/images/logo.svg") }}"
                                                                    alt="Edica"></a>
    ...
    <div class="container">
        <div class="footer-banner" data-aos="fade-up">
            ...
            <div class="banner-btns-wrapper">
                <button class="btn btn-success"><img src="{{ asset("edica/assets/images/apple@1x.svg") }}" alt="ios"
                                                     class="mr-2"> App Store
                </button>
                <button class="btn btn-success"><img src="{{ asset("edica/assets/images/android@1x.svg") }}" alt="android"
